...
func TestHreflangXDefaultMissingNoIssues(t *testing.T) {
	...
	reporter := reporters.NewHreflangXDefaultMissing()
	if reporter.ErrorType != reporter_errors.ErrorHreflangMissingXDefault {
...
func TestHreflangMissingSelfReferenceNoIssues(t *testing.T) {
	...
	reporter := reporters.NewHreflangMissingSelfReference()
	if reporter.ErrorType != reporter_errors.ErrorHreflangMissingSelfReference {
...
func TestHreflangMismatchingLangNoIssues(t *testing.T) {
	...
	reporter := reporters.NewHreflangMismatchingLang()
	if reporter.ErrorType != reporter_errors.ErrorHreflangMismatchLang {
...
func TestHreflangRelativeURLNoIssues(t *testing.T) {
	...
	reporter := reporters.NewHreflangRelativeURL()
	if reporter.ErrorType != reporter_errors.ErrorHreflangRelativeURL {
